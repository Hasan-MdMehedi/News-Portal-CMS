        ...
        <div class="row">
            ...
            <div class="col-md-12">
              ...
              if (mysqli_num_rows($result) > 0) {
                  echo '<div class="row" style="margin-bottom:10px;"><div class="col-md-4"><input type="text" id="category-search" class="form-control" placeholder="Search category..."></div></div>';
                  $table = '<table id="category-table" class="content-table">';
                  $table .= '<thead>
                                  <th>S.No.</th>
                                  <th>Category Name</th>
                                  <th>No. of Posts</th>
